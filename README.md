# MeArm v0.4 robot arm
 Documentation and Python code for Raspberry Pi single board computers (SBCs). The code and documentation has been updated to allow for a generalised username instead of the 'older' default username 'pi'.
...
A robot arm project, as shown above, that can use the Raspberry Pi Maker PCB to simplify interconnect but can also just as easily be connected to a Raspberry Pi in a conventional/direct way. More detailed project information is provided [here](https://onlinedevices.org.uk/Raspberry%2BPi%2B-%2BMeArm%2Brobot%2Barm%2Bproject).
