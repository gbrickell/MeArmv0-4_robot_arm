...
A robot arm project, as shown above, that can use the Raspberry Pi Maker Kit to simplify interconnect but can also just as easily be connected to a Raspberry Pi in a conventional/direct way. More detailed project information is provided [here](https://onlinedevices.org.uk/Raspberry%2BPi%2B-%2BMeArm%2Brobot%2Barm%2Bproject).
