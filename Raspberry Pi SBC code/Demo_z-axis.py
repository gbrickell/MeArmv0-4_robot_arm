...
# -*- coding: utf-8 -*-
#
#  Demo_z-axis.py - created in Sept 2018 and further updated for the Raspberry Pi Maker Kit in Nov'21 
#   move the gripper alonmg the z-axis keeping x and y constant
...
# command to run in Terminal window:   python3 /home/pi/RPi_maker_kit5/complete_projects/MeArm_v0-4/Demo_z-axis.py
...
def main():
    ...
    print ("set point 0")
    arm.gotoPoint(0, 150, 50)      # keep x and y positions constant
    ...
    print ("set point 1")
    arm.gotoPoint(0, 150, 75)     # keep x and y positions constant
    xnow, ynow, znow = arm.getPos()
    print ("current x,y,z: " + str(xnow) + ", " + str(ynow) + ", " + str(znow) )
    beep(2, 0.1)  # 0.1 second beep x2 
    LED_set(RGB_red, 'OFF')
    ...
    print ("set point 2")
    arm.gotoPoint(0, 150, 100)     # keep x and y positions constant
    xnow, ynow, znow = arm.getPos()
    print ("current x,y,z: " + str(xnow) + ", " + str(ynow) + ", " + str(znow) )
    beep(2, 0.1)  # 0.1 second beep x2 
    LED_set(RGB_red, 'OFF')
    ...
    print ("set point 3")
    arm.gotoPoint(0, 150, 125)     # keep x and y positions constant
    xnow, ynow, znow = arm.getPos()
    print ("current x,y,z: " + str(xnow) + ", " + str(ynow) + ", " + str(znow) )
    beep(2, 0.1)  # 0.1 second beep x2 
    LED_set(RGB_red, 'OFF')
    ...
    print ("set point 4")
    arm.gotoPoint(0, 150, 150)     # keep x and y positions constant
    xnow, ynow, znow = arm.getPos()
    print ("current x,y,z: " + str(xnow) + ", " + str(ynow) + ", " + str(znow) )
    beep(2, 0.1)  # 0.1 second beep x2 
    LED_set(RGB_red, 'OFF')
