...
# -*- coding: utf-8 -*-
#
#  Demo_gripper_servo.py - created in Sept 2018 and further updated for the Raspberry Pi Maker Kit in Nov'21 
#   test the operation of the gripper and add some debug output
...
# command to run: python3 /home/pi/RPi_maker_kit5/complete_projects/MeArm_v0-4/Demo_gripper_servo.py
...
def main():
    ...
    LED_set(RGB_green, 'OFF')
    arm.openGripper()
    arm.openGripper() # do it twice in case it is 'stuck'
    print ("gripper open")
