...
# -*- coding: utf-8 -*-
#
#  Demo_y-axis.py - created in Sept 2018 and further updated for the Raspberry Pi Maker Kit in Nov'21 
#   move the gripper alonmg the y-axis keeping x and z constant
...
# command to run in Terminal window:   python3 /home/pi/RPi_maker_kit5/complete_projects/MeArm_v0-4/Demo_y-axis.py
...
def main():
    ...
    print ("set point 0")
    arm.gotoPoint(0, 100, 80)     # keep x and z positions constant
    ...
    print ("set point 1")
    arm.gotoPoint(0, 125, 80)     # keep x and z positions constant
    xnow, ynow, znow = arm.getPos()
    print ("current x,y,z: " + str(xnow) + ", " + str(ynow) + ", " + str(znow) )
    beep(2, 0.1)  # 0.1 second beep x2 
    LED_set(RGB_red, 'OFF')
    ...
    print ("set point 2")
    arm.gotoPoint(0, 150, 80)     # keep x and z positions constant
    xnow, ynow, znow = arm.getPos()
    print ("current x,y,z: " + str(xnow) + ", " + str(ynow) + ", " + str(znow) )
    beep(2, 0.1)  # 0.1 second beep x2 
    LED_set(RGB_red, 'OFF')
    ...
    print ("set point 3")
    arm.gotoPoint(0, 170, 80)     # keep x and z positions constant
    xnow, ynow, znow = arm.getPos()
    print ("current x,y,z: " + str(xnow) + ", " + str(ynow) + ", " + str(znow) )
    beep(2, 0.1)  # 0.1 second beep x2 
    LED_set(RGB_red, 'OFF')
